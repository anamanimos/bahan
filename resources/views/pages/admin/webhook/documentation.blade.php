    ...
    "items": [
      {
        ...
        "subtotal": 302500
            ...
            <p class="fs-6 text-gray-600 my-5">Contoh payload untuk <strong>Penerimaan Barang (Purchase)</strong>. Data dikirimkan <strong>per lot</strong> (jika satu item memiliki 2 lot, maka akan muncul 2 baris data):</p>
            <div class="bg-light p-5 rounded">
                <pre class="mb-0 text-dark">
{
    ...
    "items": [
      ...
      },
      {
        ...
        "total": 3750000
            ...
            <p class="fs-6 text-gray-600 my-5">Contoh payload untuk <strong>Merge Produk</strong>:</p>
            <div class="bg-light p-5 rounded">
                <pre class="mb-0 text-dark">
{
