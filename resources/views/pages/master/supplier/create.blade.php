...
<div class="card card-flush">
    ...
    <div class="card-body pt-0">
        <form id="kt_ecommerce_add_supplier_form" class="form" action="{{ route('master.ajax.supplier.store') }}" method="POST">
            @csrf
            <div class="row g-9 mb-7">
                <div class="col-md-6 fv-row">
                    <label class="required form-label">Nama Supplier (Toko)</label>
                    <input type="text" name="name" class="form-control mb-2" placeholder="Masukkan nama supplier" value="" required />
                </div>
                <div class="col-md-6 fv-row">
                    <label class="form-label">PIC / Kontak Person</label>
                    <input type="text" name="contact_person" class="form-control mb-2" placeholder="Nama orang yang bisa dihubungi" value="" />
                </div>
            </div>
            ...
            <div class="row g-9 mb-7">
                <div class="col-md-6 fv-row">
                    ...
                    <input type="text" name="phone_number" class="form-control mb-2" placeholder="Contoh: 08123456789" value="" />
                </div>
                <div class="col-md-6 fv-row">
                    <label class="form-label">Alamat Lengkap</label>
                    <textarea name="address" class="form-control mb-2" rows="3" placeholder="Alamat fisik supplier"></textarea>
                </div>
            </div>
