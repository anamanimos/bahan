        ...
        <div class="card card-flush border-0 shadow-sm">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5 px-5 px-md-9">
                ...
                <div class="card-title w-100 w-md-auto">
                    <div class="d-flex align-items-center position-relative my-1 w-100">
                        ...
                        <input type="text" data-kt-inventory-gr-filter="search" class="form-control form-control-solid w-100 w-md-250px ps-12" placeholder="Cari No. GR..." />
                    </div>
                </div>
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-3 w-100 w-md-auto">
                    ...
                    <a href="<?= base_url('inventory/goods-receipt/create') ?>" class="btn btn-primary btn-sm px-4 flex-grow-1 flex-md-grow-0">
            ...
            <div class="card-body pt-0 px-0 px-md-9">
                ...
                <div class="d-none d-md-block overflow-hidden">
                    <table class="table align-middle table-row-dashed fs-6 gy-2 w-100" id="kt_inventory_gr_table">
                        <thead>
                            <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                                <th class="w-10px pe-2"><div class="form-check form-check-sm form-check-custom form-check-solid me-3"><input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#kt_inventory_gr_table .form-check-input" value="1" /></div></th>
                                <th class="min-w-100px border-start border-gray-300 ps-3">No. GR</th>
                ...
                <div id="kt_inventory_gr_mobile_container" class="d-md-none d-flex flex-column border-top border-gray-200">
                    <div class="text-center py-10 text-muted fs-7">Memuat data penerimaan...</div>
                </div>

                <!-- Mobile Pagination Placeholder -->
                <div id="kt_inventory_gr_mobile_pagination" class="d-md-none mt-5 px-5"></div>
            </div>
        </div>
    </div>
</div>
