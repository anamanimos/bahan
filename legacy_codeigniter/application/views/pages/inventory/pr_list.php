        ...
        <div class="card card-flush border-0 shadow-sm">
            ...
            <div class="card-header align-items-center py-5 gap-2 gap-md-5 px-5 px-md-9">
                ...
                <div class="card-toolbar flex-row-fluid justify-content-end gap-3 w-100 w-md-auto">
                    ...
                    <!--begin::Filter Menu (Must be a sibling for trigger to work without target)-->
                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_filter">
                        ...
                        <div class="px-7 py-5">
                            ...
                            <div class="mb-5">
                                <label class="form-label fw-semibold">Staff Pengaju:</label>
                                <div>
                                    <select class="form-select form-select-solid" id="filter_staff" data-placeholder="Pilih Staff" data-allow-clear="true" multiple="multiple">
                                        <option value="Staff Gudang A">Staff Gudang A</option>
                                        <option value="Staff Gudang B">Staff Gudang B</option>
                    ...
                    <a href="<?= base_url('inventory/purchase-requisition/create') ?>" class="btn btn-primary btn-sm px-4 flex-grow-1 flex-md-grow-0">
