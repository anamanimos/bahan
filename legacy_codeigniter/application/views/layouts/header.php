...
<html lang="en">
	<!--begin::Head-->
	<head>
		<title>Toko Kain Garment - Integrated ERP</title>
		<meta charset="utf-8" />
        ...
        <?php if (isset($css)): ?>
            <?php foreach ($css as $file): ?>
                <link href="<?= base_url($file) ?>" rel="stylesheet" type="text/css" />
            <?php endforeach; ?>
        <?php endif; ?>
					...
					<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
							<a href="<?= base_url() ?>" class="d-lg-none">
								<img alt="Logo" src="<?= base_url('assets/vendors/media/logos/default-small.svg') ?>" class="h-30px" />
							</a>
						</div>
						<!--end::Mobile logo-->
							...
							<div class="app-navbar flex-shrink-0">
								...
								<div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
									...
									<div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										<img src="<?= base_url('assets/vendors/media/avatars/300-3.jpg') ?>" class="rounded-3" alt="user" />
									</div>
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="<?= base_url('assets/vendors/media/avatars/300-3.jpg') ?>" />
												</div>
												<!--end::Avatar-->
												<!--begin::Username-->
